...
import { LayoutGrid, AtSign, Camera, Youtube, Music } from "lucide-react";
import { clsx } from "clsx";

const TABS = [
  { href: "/distribution", label: "Hub", icon: LayoutGrid, exact: true },
  { href: "/distribution/x", label: "X", icon: AtSign, color: "text-white" },
  { href: "/distribution/instagram", label: "Instagram", icon: Camera, color: "text-pink-400" },
  { href: "/distribution/youtube", label: "YouTube", icon: Youtube, color: "text-red-400" },
  { href: "/distribution/tiktok", label: "TikTok", icon: Music, color: "text-cyan-400" },
];
